...
## Neste repositório nós temos algumas soluções baseadas em Processamento de Imagem e também um projeto que consiste em remoção de background na construção de modelos utilizados para fins de Person Re-Identification. Mais detalhes nos links a seguir.
